...
export const AGENT_REGISTRY: Record<string, AgentIdentity> = {
  ...
  designer:    { id: 'designer',    name: 'Designer',     emoji: '\u{1F3A8}',       department: 'marketing',   color: 0xEC4899 },
  reviewer:    { id: 'reviewer',    name: 'Reviewer',     emoji: '\u{1F50D}',       department: 'development', color: 0x059669 },
  ...
  scout:       { id: 'scout',       name: 'Scout',        emoji: '\u{1F52D}',       department: 'executive',   color: 0x8B5CF6 },
  keeper:      { id: 'keeper',      name: 'Keeper',       emoji: '\u{1F6E1}\uFE0F', department: 'support',     color: 0x0EA5E9 },
  sentinel:    { id: 'sentinel',    name: 'Sentinel',     emoji: '\u{1F510}',       department: 'audit',       color: 0xDC2626 },
  forge:       { id: 'forge',       name: 'Forge',        emoji: '\u2692\uFE0F',    department: 'development', color: 0x78716C },
