...
export function PendingApprovalsWidget() {
  ...
  return (
    <div className="border border-mc-warning/30 rounded-lg bg-mc-warning/5 px-4 py-3">
      <div className="flex items-center justify-between">
        <div>
          <div className="text-xs font-mono font-bold text-mc-warning">
        ...
        <Link
          ...
          className="text-[10px] font-mono text-mc-warning hover:text-mc-text transition-colors"
        >
          View All →
        </Link>
      </div>
